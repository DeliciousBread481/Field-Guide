package com.evandev.mobendium.client;

import com.evandev.mobendium.config.ModConfig;
...
public class MobDataManager {
    ...
    public static String getEntityDescription(EntityType<?> type) {
        ...
        return I18n.get("mobendium.description.missing");
    }
